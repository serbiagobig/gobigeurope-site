...
s = s.replace(
    ...
    '<p class="section-lead" style="margin-top:20px">Расширение географии бизнеса увеличивает продажи и снижает зависимость от одного рынка. В условиях нестабильной экономической среды это минимизирует риски и позволяет адаптироваться к глобальным вызовам. Международная деятельность подтверждает высокое качество продуктов и услуг и демонстрирует профессионализм команды, укрепляя доверие клиентов и партнёров.</p><p class="section-lead" style="margin-top:28px">Мы помогаем превратить намерение выйти на новый рынок в понятный маршрут: от выбора страны и бизнес-модели до первых переговоров, партнёров и устойчивого присутствия.</p>'
)
