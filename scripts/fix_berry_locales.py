...
IMG_AIR = RAW + '%D0%9A%D0%B0%D1%80%D1%82%D0%BE%D1%87%D0%BA%D0%B0%20%D0%92%D0%BE%D0%B7%D0%B4%D1%83%D1%88%D0%BD%D0%B0%D1%8F%20%D1%83%D0%B1%D0%BE%D1%80%D0%BA%D0%B0.png'
...
tech_content = {
    'ru': {
        ...
        'cards': [
            ('01', IMG_AIR, 'Воздушно-импульсное воздействие', 'Управляемые импульсы воздуха отделяют зрелые плоды от растения. Скорость и частота воздействия регулируются под культуру и условия уборки.'),
            ('02', IMG_SOFT, 'Мягкая система приёма', 'Эластичные пневматические элементы принимают отделившийся урожай, поглощают энергию падения и помогают снизить риск повреждения.'),
            ('03', IMG_GUIDE, 'Адаптация к культуре', 'Направляющие элементы помогают работать с различной формой куста и ветвей. При необходимости механическое воздействие дополняет воздушный импульс и остаётся под контролем оператора.'),
        ],
    },
    'en': {
        'eyebrow': 'Technology',
        ...
        'cards': [
            ('01', IMG_AIR, 'Air-pulse action', 'Controlled air pulses detach ripe fruit from the plant. Air speed and pulse frequency are adjusted to the crop and harvesting conditions.'),
            ('02', IMG_SOFT, 'Gentle receiving system', 'Elastic pneumatic elements receive the detached crop, absorb impact energy and help reduce the risk of damage.'),
            ('03', IMG_GUIDE, 'Adaptation to the crop', 'Guiding elements help the machine work with different bush shapes and branch structures. When needed, controlled mechanical action complements the air pulse.'),
        ],
    },
    'cz': {
        'eyebrow': 'Technologie',
        ...
        'cards': [
            ('01', IMG_AIR, 'Vzduchově pulzní působení', 'Řízené vzduchové impulsy oddělují zralé plody od rostliny. Rychlost vzduchu a frekvence impulsů se nastavují podle plodiny a podmínek sklizně.'),
            ('02', IMG_SOFT, 'Šetrný systém zachycení', 'Elastické pneumatické prvky zachycují oddělenou úrodu, absorbují energii pádu a pomáhají snižovat riziko poškození.'),
            ('03', IMG_GUIDE, 'Přizpůsobení plodině', 'Vodicí prvky pomáhají pracovat s různým tvarem keřů a větví. V případě potřeby řízené mechanické působení doplňuje vzduchový impuls.'),
        ],
    },
}
...
.tech-visual-grid{display:grid;grid-template-columns:repeat(3,1fr);gap:18px;margin-top:28px}
.tech-visual-card{overflow:hidden;border:1px solid rgba(255,255,255,.14);border-radius:24px;background:#1c2d3b}
.tech-visual-media{height:220px;overflow:hidden;background:#0e1c28}
