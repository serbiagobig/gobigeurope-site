...
# generate the Berry routes, rebuild locale navigation, remove any runtime Cyrillic
# residuals, and only then run strict QA.
...
run('remove_locale_cyrillic_residuals.py')
