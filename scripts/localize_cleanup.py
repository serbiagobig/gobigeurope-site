...
# These post-passes repair late runtime/project content, generate the approved Berry
# locales, rebuild locale navigation, repair known runtime language contamination and
# visual regressions, normalize shared asset paths, and only then run strict QA.
